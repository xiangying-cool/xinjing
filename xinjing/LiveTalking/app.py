...
if __name__ == '__main__':
    ...
    parser.add_argument('--llm_provider', type=str, default='dashscope', choices=['dashscope', 'ollama'], help="llm backend provider")
    parser.add_argument('--llm_model', type=str, default='qwen-plus', help="chat model name; e.g. qwen-plus or qwen2.5:7b")
    parser.add_argument('--llm_base_url', type=str, default='https://dashscope.aliyuncs.com/compatible-mode/v1', help="openai-compatible base url for dashscope")
    parser.add_argument('--llm_api_key_env', type=str, default='DASHSCOPE_API_KEY', help="env var name for llm api key")
    parser.add_argument('--ollama_url', type=str, default='http://127.0.0.1:11434', help="ollama server url")
    parser.add_argument('--llm_max_history', type=int, default=8, help="max chat turns kept in memory per session")
    parser.add_argument('--llm_temperature', type=float, default=0.7, help="llm sampling temperature")
    ...
    pagename='webrtcchat.html'
    if opt.transport=='rtmp':
        pagename='echoapi.html'
    elif opt.transport=='rtcpush':
        pagename='rtcpushchat.html'
